...
Not all softwares was possibile to install in your virtual machines, so we need to concentrate in two softwares (STAR-FUSION and Jaffa). We  present also Defuse but for discussing the ouput.
...
At the moment the best program for detect fusion are not unic so it is importnt to use many tools. The Ensemble of  many programs are the best solution avaible.
